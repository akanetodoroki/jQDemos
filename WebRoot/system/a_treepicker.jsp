...
<html>
  <head>
	...
	<script type="text/javascript" src="ext4.2/ux/TreePicker.js"></script>
	<script type="text/javascript" src="system/mytreepicker.js"></script>
	<script type="text/javascript" src="system/fn_compilers.js"></script>
	<script type="text/javascript" src="system/a_treepicker.js"></script>
	<script type="text/javascript" src="system/mytreepicker1.js"></script>
	<style type="text/css">
	</style>
