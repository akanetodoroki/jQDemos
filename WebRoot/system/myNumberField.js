Ext.define('Ext.form.DecimalField',{
    ...
    valueToRaw: function(value) {
        ...
        //value = Ext.isNumber(value) ? value : parseFloat(String(value).replace(decimalSeparator, '.'));//parseFloat(10.00)==10
    ...
    fixPrecision : function(value) {
        ...
        return Ext.Number.toFixed(parseFloat(value), precision);//改
    },
    ...
    onSpinUp: function() {
        var me = this;
        //console.log(typeof me.value);//String
        if (!me.readOnly) {
        	//me.setValue(Ext.Number.constrain(me.getValue() + me.step, me.minValue, me.maxValue));
            me.setValue(Ext.Number.constrain(eval(me.getValue()) + me.step, me.minValue, me.maxValue));//改
        }
    },
