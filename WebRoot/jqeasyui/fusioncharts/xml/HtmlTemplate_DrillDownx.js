     ...
     <td align="left">
       <div id='SalesByCategoryDiv' align='center'>
         <script type="text/javascript">
          var chart_SalesByProd = new FusionCharts( { "swfUrl" : "e:/2delphitemplate/system/charts/swf/MSColumn3DLineDY.swf?ChartNoDataText=请在上图选择一个产品类别查看所有产品销售.", 
...
<script type="text/javascript">
	initData();//初始化操作
	function initData(){
	var Category_Pie_Chart =new FusionCharts("e:/2delphitemplate/system/charts/swf/Pie3D.swf","category","875","350","0","0");
	...
	var chartObj = FusionCharts("SalesByCategory"); 
 	chartObj.setDataURL("e:/2delphitemplate/system/charts/xml/category_product"+flag+".xml");
      }
