...
<script>
	$(document).ready(function() {
		...
		myFieldset('myFieldset1','myEditWin1','商品信息',10,10,240,410);
		...
		myFileField('filename','myFieldset1',36*5+20,16,0,384,'right','fnPictureupLoad');
		myImageField('picture','myFieldset2','',0,1,1,231,188,'');
