...
<div id="main" style="margin:2px 2px 2px 2px;">
	<div class="easyui-panel" id="myForm1" title="&nbsp;学生信息编辑" style="position:relative; background:#fafafa;" data-options="iconCls:'panelIcon'" >
		<fieldset id="myFieldset1" style="position:absolute; top:10px; left:10px; width:300px; height:210px; padding: 2px 0px 0px 16px; border:1px solid #B5B8C8;" >
			<legend>基本信息</legend>
			...
			<label id='birthdate_label'>出生日期：</label><div id="birthdate_div"><input class="easyui-datebox" type="text" id="birthdate"></input></div>
		...
		<fieldset id="myFieldset2" style="position:absolute; top:235px; left:10px; width:300px; height:180px; padding: 2px 0px 0px 16px; border:1px solid #B5B8C8;" >
			<legend>通信信息</legend>
			<label id='address_label'>家庭地址：</label>
			<div id="address_div"><input class="easyui-textbox" type="text" id="address" style="padding:0px 2px 0px 4px"></input></div> 
			<label id='mobile_label'>手机号码：</label>
			<div id="mobile_div"><input class="easyui-textbox" type="text" id="mobile" style="padding:0px 2px 0px 4px"></input></div> 
			<label id='homephone_label'>家庭电话：</label>
			<div id="homephone_div"><input class="easyui-textbox" type="text" id="homephone" style="padding:0px 2px 0px 4px"></input></div>
			<label id='email_label'>Email：</label>
			<div id="email_div"><input class="easyui-textbox" type="text" id="email" style="padding:0px 2px 0px 4px"></input></div>
			<label id='weixin_label'>微信号：</label>
			<div id="weixin_div"><input class="easyui-textbox" type="text" id="weixin" style="padding:0px 2px 0px 4px"></input></div>
		</fieldset>
	</div>
</div>
<script>
	$(document).ready(function(){
		//example03_absolutelayout.jsp
		//控件位置布局
