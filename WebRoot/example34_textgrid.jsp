...
<div id="main" class="easyui-layout" data-options="split:true, fit:true" style="margin:1px 1px 1px 1px;">
	<div class='easyui-panel' data-options="region:'west', split:true" style="overflow:hidden; width:230px; padding: 1px 1px 1px 1px;border-width:0px;">
		<div class="easyui-layout" data-options="fit:true" style="margin:0px 0px 0px 0px; border-width:0px;">
			<div id='toolbar1' class='easyui-panel' data-options="region:'north'" style="overflow:hidden; background-color:#E0ECFF; height:28px; padding:0px 0px 0px 2px; border-width:1px; "></div>
			<div id='treepanel' class='easyui-panel' data-options="region:'center'" style="overflow:auto; margin:1px 1px 1px 1px; border-width:1px;"></div>
		</div>	
	</div>
	<div  class='easyui-panel' data-options="region:'center',fit:true" style="margin:0px 0px 0px 0px; padding: 0px 0px 0px 0px; border:1px;">
		<div id="mainpanel" class="easyui-layout" data-options="fit:true" style="margin:0px 0px 0px 0px;">
			<div id="toolbar2" class='easyui-panel' data-options="region:'north'" style="overflow:hidden; background-color:#E0ECFF; height:28px; padding:0px 0px 0px 16px;"></div>
			<div id='wineditpanel' class='easyui-panel' data-options="region:'center'" style="overflow:auto; margin:0px 1px 2px 1px; padding:1px 2px 2px 1px; "></div>
		</div>					
	</div>
</div>
<script>
