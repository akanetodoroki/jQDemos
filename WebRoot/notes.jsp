...
$(document).ready(function() {
	...
	pmyGrid1.staticsql="select id,date,text from meetingnotes"
	...
	var xcolumns=[
		[  //第一层开始
		 { title: '时间', field:'date', width: 200, halign:'center', align: 'left', rowspan:2 },
		 { title: '内容', field:'text', width: 1300, halign:'center', align: 'left', rowspan:2 },
