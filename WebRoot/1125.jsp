<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
    ...
    <body class="easyui-layout" fit="true" style="margin: 2px 2px 2px 2px;">
        <div id='container' class='easyui-panel' data-options="region:'north'" style="overflow:hidden; background-color: #E0ECFF; height:98px; ">
            ...
            <div id='tool' class='easyui-panel' data-options="region:'center'" style="overflow:hidden; background-color: #E0ECFF; height:33px; padding: 1px 1px 1px 10px;">
        ...
        <div id='bottom' class='easyui-panel' data-options="region:'south'" style="padding: 1px 1px 1px 1px;height:270px"></div>
        <script>
            $(function() {
                var pmyGrid1 = {};
                pmyGrid1.id = 'myGrid1';
