...
<script>
	...
	$(document).ready(function(){
		...
		myFieldset('myFieldset2','myForm1','',17,285,233,226);
		...
		//定义图片
		var str='<img id="image1" src="" style="border:false; position:absolute; top:1px; left:1px; width:224px; height:230px;"></img>';
