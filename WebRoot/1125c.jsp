...
<body class="easyui-layout" fit="true" style="margin: 2px 2px 2px 2px;">
	...
	<div id='bottom' class='easyui-panel' data-options="region:'east'" style="padding: 1px 1px 1px 1px;width:350px;width:300px;"></div>
<script>
	$(function() {
		var pmyGrid1={};
		pmyGrid1.id='myGrid1';
		...
		myTextField('quantity','bottom','数量:',40,154,10,0,120,'','','');
		myTextField('unitprice','bottom','单价:',40,184,10,0,120,'','','');
