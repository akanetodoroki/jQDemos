...
<body class="easyui-layout" fit="true" style="margin: 2px 2px 2px 2px;">
	...
	<div id="container" class="easyui-panel" fit="true" data-options="region:'center'">
		...
		<div id='bottom' class='easyui-panel' data-options="region:'south'" style="padding: 1px 1px 1px 1px;height:110px;width:830px;"></div>
	</div>
<script>
	$(function() {
		var pmyGrid1={};
		...
		pmyGrid1.staticsql="select a.ProductID,a.ProductName,a.QuantityPerUnit,a.Unit,b.Quantity,b.UnitPrice,b.Quantity*b.UnitPrice as amount from Products a ";
		pmyGrid1.staticsql+="join OrderItems b on a.ProductID=b.ProductID ";
		...
		$("#myTree1").tree({
			onSelect: function (node){ 
				...
				if(pid.length==11){
					...
					if (wheresql!='') pmyGrid1.activesql=pmyGrid1.staticsql+' '+wheresql;
