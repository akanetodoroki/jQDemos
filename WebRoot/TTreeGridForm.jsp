...
<html>
	...
	<script type="text/javascript">
  	//树+可编辑表格+form, modal='window'时左侧为树，右侧为表格，否则form显示在右侧下方
	...
	Ext.onReady(function(){
		...
		//获取tree值
		pmyTree1=myGetTreeAttrs(p.tree[0],pmyTree1);
	    ...
	    //pmyTree1.fields+="cid;text;sysnumber;parentnodeid;isparentflag;level;ancester";
		if (pmyTree1.tablename=='') pmyTree1.tablename=pmyTable.tablename;
		if (pmyTree1.keyfield=='') pmyTree1.keyfield=pmyTable.keyfield;
		if (pmyTree1.keyspec=='') pmyTree1.keyspec=pmyTable.keyspec;
		if (pmyTree1.sortfield=='')	pmyTree1.sortfield=pmyTable.sortfield;
